                          ...
                          <tr key={index}>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <input
                                ...
                                onChange={() =>
                                  markCompleted(val._id, val.isCompleted)
                                }
                              />
                            </td>
                            <td
                              className={`px-5 py-5 border-b border-gray-200 bg-white text-sm flex group`}
                            >
                              <pre
                                className={`todo-title whitespace-no-wrap px-3 float-left ${
                                  val.isCompleted
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <pre className="text-gray-900 whitespace-no-wrap">
                                {moment(val.updatedAt ?? val.createdAt).format(
